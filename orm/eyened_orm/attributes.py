...
class AttributeValue(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "(ImageInstanceID IS NOT NULL AND SegmentationID IS NULL AND ModelSegmentationID IS NULL) OR "
            "(ImageInstanceID IS NULL AND SegmentationID IS NOT NULL AND ModelSegmentationID IS NULL) OR "
            "(ImageInstanceID IS NULL AND SegmentationID IS NULL AND ModelSegmentationID IS NOT NULL)",
    ...
    # Provenance tracking
    InputValues: Mapped[List["AttributeValue"]] = relationship("eyened_orm.attributes.AttributeValue", secondary="AttributeValueInput", primaryjoin="AttributeValue.AttributeValueID == AttributeValueInput.OutputAttributeValueID", secondaryjoin="AttributeValue.AttributeValueID == AttributeValueInput.InputAttributeValueID", back_populates="UsedByValues")
    UsedByValues: Mapped[List["AttributeValue"]] = relationship("eyened_orm.attributes.AttributeValue", secondary="AttributeValueInput", primaryjoin="AttributeValue.AttributeValueID == AttributeValueInput.InputAttributeValueID", secondaryjoin="AttributeValue.AttributeValueID == AttributeValueInput.OutputAttributeValueID", back_populates="InputValues")
