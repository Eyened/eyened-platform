...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('CreatorID', 'TagID')
    )
...
def downgrade() -> None:
    ...
    op.drop_column('Tag', 'DateInserted')
    op.drop_column('Tag', 'CreatorID')
    op.drop_column('Tag', 'TagDescription')
    op.drop_column('Tag', 'TagType')
    op.drop_constraint(None, 'StudyTag', type_='foreignkey')
    op.drop_index('fk_StudyTag_Creator1_idx', table_name='StudyTag')
    op.drop_column('StudyTag', 'DateInserted')
    op.drop_column('StudyTag', 'CreatorID')
    op.drop_constraint(None, 'SegmentationTag', type_='foreignkey')
    ...
    op.drop_column('FormAnnotationTag', 'CreatorID')
