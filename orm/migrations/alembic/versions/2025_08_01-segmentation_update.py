...
def upgrade() -> None:
    ...
    op.alter_column("Contact", "Name", existing_type=mysql.VARCHAR(length=256), type_=sqlmodel.sql.sqltypes.AutoString(length=255), existing_nullable=False)
    op.alter_column("Contact", "Email", existing_type=mysql.VARCHAR(length=256), type_=sqlmodel.sql.sqltypes.AutoString(length=255), existing_nullable=False)
    op.alter_column("Contact", "Institute", existing_type=mysql.VARCHAR(length=256), type_=sqlmodel.sql.sqltypes.AutoString(length=255), existing_nullable=True)
    ...
    op.alter_column("FormSchema", "SchemaName", existing_type=mysql.VARCHAR(length=45), type_=sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False)
    ...
    op.alter_column("Patient", "PatientIdentifier", existing_type=mysql.VARCHAR(length=45), type_=sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False)
    ...
    op.alter_column("Project", "ProjectName", existing_type=mysql.VARCHAR(length=45), type_=sqlmodel.sql.sqltypes.AutoString(length=255), existing_nullable=False)
