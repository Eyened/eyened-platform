...
***deploy:*** The one Docker stack — database, Redis, server, client, and file server. Its entry
point is `./eyened` at the repository root, the single command both clients and developers use.
Start here.
