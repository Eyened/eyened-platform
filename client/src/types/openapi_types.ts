...
export type SegmentationDataRepresentation =
    components["schemas"]["DataRepresentation"];
export type ModelSegmentationGET =
    components["schemas"]["ModelSegmentationGET"];
...
export type ImageGET = components["schemas"]["ImageGET"];
...
export type PatientAttributeValueGET =
    components["schemas"]["PatientAttributeValueGET"];
...
export type StudySearchCondition =
    components["schemas"]["StudySearchCondition"];
...
export type SubTaskWithImagesGET =
    components["schemas"]["SubTaskWithImagesGET"];
export type SubTasksResponse = components["schemas"]["SubTasksResponse"];
export type SubTasksWithImagesResponse =
    components["schemas"]["SubTasksWithImagesResponse"];
