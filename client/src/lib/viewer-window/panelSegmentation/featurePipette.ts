...
import { segToImageMatrix, segmentationPlaneSize } from '$lib/webgl/segmentationProjection';
...
function isMultiFeatureRep(
	rep: string,
): rep is MultiFeatureRep {
...
function hasIndependentMaskAtPixel(
	...
	return readAnnotationAtPixel(mask, segmentation, segmentationItem, pixel.idx) > 0;
}
