...
import type { Segmentation, SegmentationContext } from "./segmentationContext.svelte";
import {
	imageBoxHeight,
	imageBoxWidth,
...
export type SegmentationTypeChoice = (typeof SEGMENTATION_TYPE_OPTIONS)[number]["value"];
...
export function dataTypeForType(type: SegmentationTypeChoice): SegmentationDataType {
...
export async function createSegmentationFromDialog(
	...
	const { image, axis, feature, subtaskId, type, mode, box, segWidth, segHeight } =
		params;
