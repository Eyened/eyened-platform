...
export class LayerBoundaries {
    ...
    constructor(
        ...
        readonly layersTexture: WebGLTexture,
    ) {
    ...
    calculateBoundaries() {
        ...
        if (
            !checkFramebufferContext(
                gl,
                framebuffer,
                "LayerBoundaries.calculateBoundaries",
            )
        ) {
            console.error(
                "Skipping LayerBoundaries.calculateBoundaries due to framebuffer context violation",
            );
            return;
        }
