...
:::note
The setup script will create a `.platform_credentials` file containing your login information. Please keep this file secure and delete it after you've noted the credentials.
:::
