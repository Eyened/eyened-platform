...
:::note
For detailed information about entity fields available for each level (Patient, Study, Series, Image), see the [Metadata Fields documentation](/eyened-platform/import_metadata_fields).
:::
...
The `props` dictionaries at each level can include any of the fields documented in the [Metadata Fields documentation](/eyened-platform/import_metadata_fields). These properties are used to populate the corresponding database objects.
