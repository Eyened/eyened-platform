...
- **[ORM Importer](/eyened-platform/orm/importer)**: Import and patch data using `ImportRow` + `ImportRun` (plan/review/apply, CSV support, audit/undo).
...
- **[Command Line Utilities](/eyened-platform/orm/cli)**: Database dumps, thumbnail repair, model execution, and other maintenance tasks.
