...
2. Apply the migration on the test database (from the migrations directory):
   ...
   :::caution
   Make sure Alembic is pointing to the correct database (check `alembic.ini`).
   :::
