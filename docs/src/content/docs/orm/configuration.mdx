...
| default_study_date | No | Default date for new studies. When the importer needs to create new studies and it does not receive a study date, it will use this default date. Defaults to 1970-01-01 |
